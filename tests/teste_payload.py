...
from app import logo, openai_client, pexels, pipeline, render, rosto, sorteio
...
async def gerar(dados: dict) -> Path:
    ...
    notas = await openai_client.curar_fotos(vaga["titulo"], contexto, rosto.candidatas_curadoria(pool))
